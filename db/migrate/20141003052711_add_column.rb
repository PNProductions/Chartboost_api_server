class AddColumn < ActiveRecord::Migration
  def change
    ...
    add_column :chartboost_instances, :gaid, :string, null: false, default: ''
    add_column :chartboost_instances, :formatted_ifa, :string, null: false, default: ''
    ...
    add_column :chartboost_instances, :to_store_id, :string, null: false, default: ''
    add_column :chartboost_instances, :from_store_id, :string, null: false, default: ''
